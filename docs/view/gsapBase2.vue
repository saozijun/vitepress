...
const init = () => {
    nextTick(async () => {
        ...
        b1tl.to(b1.value, {x: -520, y: -320, opacity: 1, scale: 1, duration: 1.6 }, 0)
        b1tl.to(b2.value, {x: -260, y: -320, opacity: 1, scale: 1,  duration: 1.2 }, 0)
        b1tl.to(b3.value, {y: -320, opacity: 1, scale: 1,  duration: .8 }, 0)
        b1tl.to(b4.value, {x: 520, y: -320, opacity: 1, scale: 1,  duration: 1.6 }, 0)
        b1tl.to(b5.value, {x: 260, y: -320, opacity: 1, scale: 1,  duration: 1.2 }, 0)
        b1tl.to(b6.value, {x: -520, opacity: 1, scale: 1,  duration: 1.6 }, 0)
        b1tl.to(b7.value, {x: -260, opacity: 1, scale: 1,  duration: 1.2 }, 0)
        b1tl.to(b8.value, {x: 520, opacity: 1, scale: 1,  duration: 1.6 }, 0)
        b1tl.to(b9.value, {x: 260, opacity: 1, scale: 1,  duration: 1.2 }, 0)
        
        b1tl.to(b10.value, {x: -520, y: 320, scale: 1,  opacity: 1, duration: 1.6 }, 0)
        b1tl.to(b11.value, {x: -260, y: 320, scale: 1,  opacity: 1, duration: 1.2 }, 0)
        b1tl.to(b12.value, {y: 320, opacity: 1,scale: 1,  duration: .8 }, 0)
        b1tl.to(b13.value, {x: 520, y: 320,scale: 1,  opacity: 1, duration: 1.6 }, 0)
